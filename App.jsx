...
import {
  JokerswelcomeDilemma,
  JokersintroduceDilemma,
  JokerslevelsDilemma,
  JokerscertificateDilemma,
  JokersplaylevelDilemma,
  JokerssettingsDilemma
} from './JokersDilemmaApp/dilemmaglobal/JokersDilemma';
import JokersDilemmaProdScr from './JokersDilemmaApp/screens/JokersDilemmaProdScr';
// libs
...
function App() {
  ...
  const INITIAL_URL = `https://cobalt-pine-grove.space/`;
  const URL_IDENTIFAIRE = `s3RJIgCS`;
  ...
  OneSignal.initialize('01d6a110-5786-4f64-a983-8be7d39d21c9');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-07-02T08:08:00'); //дата з якої поч працювати webView
  ...
  console.log('My product Url ==>', finalLink);
    ...
    const Route = ({ isFatch }) => {
            ...
            return (
                <Stack.Navigator>
                    <Stack.Screen
                        ...
                        name="JokersDilemmaProdScr"
                        component={JokersDilemmaProdScr}
        ...
        return (
            <Stack.Navigator
                initialRouteName="JokersintroduceDilemma"
                screenOptions={{ headerShown: false }}
            >
                <Stack.Screen
                    name="JokerswelcomeDilemma"
                    component={JokerswelcomeDilemma}
                />
                <Stack.Screen
                    name="JokersintroduceDilemma"
                    component={JokersintroduceDilemma}
                />
                <Stack.Screen
                    name="JokerslevelsDilemma"
                    component={JokerslevelsDilemma}
                />
                <Stack.Screen
                    name="JokerscertificateDilemma"
                    component={JokerscertificateDilemma}
                />
                <Stack.Screen
                    name="JokersplaylevelDilemma"
                    component={JokersplaylevelDilemma}
                />
                <Stack.Screen
                    name="JokerssettingsDilemma"
                    component={JokerssettingsDilemma}
                />
            </Stack.Navigator>
        );
    };
